...
const TestPage = () => {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        <button onClick={handleJoinRoom} disabled={!connected} style={{ marginRight: '10px' }}>
          Join Room
        </button>
        <button onClick={handlePlaceBet} disabled={!connected} style={{ marginRight: '10px' }}>
          Place Bet
        </button>
        <button onClick={handleDealCards} disabled={!connected} style={{ marginRight: '10px' }}>
          Deal Cards
        </button>
        <button onClick={handleRevealCards} disabled={!connected}>
          Reveal Cards
        </button>
      </div>
